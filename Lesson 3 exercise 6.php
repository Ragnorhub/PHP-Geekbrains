...
<body>
	<div id="content">
		...
		<div id="footer">
			<p>Copyright &copy; <em><?php echo $h1 ?></em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija </a><?php echo date("Y");?></p>
		</div>	
	</div>
</body>
</html>